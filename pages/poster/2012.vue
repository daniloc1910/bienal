<template>
    <div class="container black-bg">
        ...
        <div @click="$router.go(-1)" class="close-button medium-p white">Fechar</div>

        <div class="id-poster grid">
            <div class="anoautor">
                <div class="title white ano">2012</div>
                <div class="title white autor">30 cartazes elaborados por diferentes autores brasileiros</div>
            </div>

            <div class="description">
                <div class="p white">Intitulada A iminência das poéticas, essa edição da Bienal adotou a metáfora da constelação como proposta curatorial e estabeleceu articulações discursivas entre passado e presente; centro e periferia; objeto e linguagem. Com grande número de obras de cada artista, a exposição privilegiou artistas latino-americanos e prestou homenagens a Arthur Bispo do Rosário e Waldemar Cordeiro. O projeto Mobile Radio montou uma estação de rádio no mezanino do pavilhão, com programação que se estendeu por todo o período da exposição.</div>
            </div>
        ...
        <div class="grid">
            <div class="info">
                <div class="medium-p gray">Presidente da Bienal: Heitor Martins<br>
Curador: Luis Pérez-Oramas<br>
Curadores-adjuntos: André Severo, Tobi Maier<br>
Curadora-assistente: Isabela Villanueva</div>
            </div>
        </div>
